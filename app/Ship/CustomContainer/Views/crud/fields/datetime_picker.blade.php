...
<input type="hidden" class="form-control" name="{{ $field['name'] }}"
...
<div class="input-group date">
    <input type="text"
        ...
        data-init-function="bpFieldInitDateTimePickerElement" @include('customcontainer::crud.fields.inc.attributes')>
...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        ...
        <link rel="stylesheet"
            href="{{ asset('packages/pc-bootstrap4-datetimepicker/build/css/bootstrap-datetimepicker.min.css') }}">
    @endpush
