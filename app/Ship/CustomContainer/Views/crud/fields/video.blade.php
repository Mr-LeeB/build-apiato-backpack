...
<div class="input-group">
    <input @include('customcontainer::crud.fields.inc.attributes', ['default_class' => 'video-link form-control']) type="url" id="{{ $field['name'] }}_link">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (typeof(data.items[0]) != "undefined") {
                            ...
                            video.id = videoId;
                            video.title = v.title;
                            video.image = v.thumbnails.maxres ? v.thumbnails.maxres.url : v.thumbnails.default
                                .url;
