    ...
    <div class="container">
      ...
      <div class="row">
          <div class="col-sm-12">
              ...
              @include('customcontainer::crud.fields.inc.translatable_icon', ['field' => $primary_dependency])
          </div>
      </div>
      ...
      <div class="row">
          <div class="col-sm-12">
              ...
              @include('customcontainer::crud.fields.inc.translatable_icon', ['field' => $secondary_dependency])
          </div>
      </div>
