...
<div>
    ...
    <input type="hidden" name="{{ $field['name'] }}" data-iconset="{{ $field['iconset'] }}"
        data-init-function="bpFieldInitIconPickerElement" value="{{ $field['value'] ?? ($field['default'] ?? '') }}"
...
@if ($crud->fieldTypeNotLoaded($field))
    ...
    @push('crud_fields_styles')
        ...
        <link rel="stylesheet"
            href="{{ asset('packages/bootstrap-iconpicker/bootstrap-iconpicker/css/bootstrap-iconpicker.min.css') }}" />
    @endpush
    ...
    @push('crud_fields_scripts')
        ...
        <script type="text/javascript"
            src="{{ asset('packages/bootstrap-iconpicker/bootstrap-iconpicker/js/bootstrap-iconpicker.bundle.min.js') }}">
        </script>
