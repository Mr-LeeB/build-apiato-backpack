...
<textarea name="{{ $field['name'] }}" data-init-function="bpFieldInitSimpleMdeElement"
    ...
    @include('customcontainer::crud.fields.inc.attributes', ['default_class' => 'form-control'])>{{ $field['value'] ?? ($field['default'] ?? '') }}</textarea>
