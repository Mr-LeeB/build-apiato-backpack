...
<div class="input-group date">
    <input
        ...
        data-init-function="bpFieldInitDatePickerElement" type="text" @include('customcontainer::crud.fields.inc.attributes')>
    ...
    @push('crud_fields_scripts')
        ...
        @if ($field_language !== 'en')
            <script charset="UTF-8"
                src="{{ asset('packages/bootstrap-datepicker/dist/locales/bootstrap-datepicker.' . $field_language . '.min.js') }}">
            </script>
        @endif
        <script>
            if (jQuery.ui) {
