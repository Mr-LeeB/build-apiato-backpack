...
trait Read
{
    ...
    public function enableBulkActions()
    {
        ...
        $this->addColumn([
            'type' => 'checkbox',
            'name' => 'bulk_actions',
            'label' => '<div class="form-check form-check-sm form-check-custom form-check-solid me-3"><input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#tableproduct .form-check-input" value="1" style="width: 16px; height: 16px;"/> </div>',
            'priority' => 0,
            'searchLogic' => false,
            'orderable' => false,
            'visibleInTable' => true,
